            ...
            <div style={{
                ...
                <div>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        <li><Link to="/about" onClick={() => window.scrollTo(0, 0)} style={{ textDecoration: 'none', color: 'var(--color-text-muted)', fontSize: '0.95rem', transition: 'color 0.3s' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--color-primary)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--color-text-muted)'}>About Us</Link></li>
